            ...
            <div className="container footer-container">
                ...
                <div className="footer-content">
                    <div className="footer-item">
                        <a href="use.html" className="footer-item-link">Условия пользования</a>
                        <a href="conf.html" className="footer-item-link">Политика кофидинчиальности</a>
                        <a href="#" className="footer-item-link">Управление файлами cookies</a>
                    </div>
                </div>
